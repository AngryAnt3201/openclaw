// ---------------------------------------------------------------------------
// Vault Metadata Parser – extracts structured metadata from markdown content
// ---------------------------------------------------------------------------

import { parse as parseYaml, stringify as stringifyYaml } from "yaml";
import type { VaultHeading, VaultLink, VaultNoteMetadata, VaultTag } from "./types.js";
...
export function extractWikilinks(content: string): VaultLink[] {
...
export function extractTags(content: string): VaultTag[] {
  const fenceRanges = findCodeFenceRanges(content);
  const tags: VaultTag[] = [];
  let match: RegExpExecArray | null;
...
export function extractHeadings(content: string): VaultHeading[] {
...
export function parseVaultMetadata(content: string): VaultNoteMetadata {
